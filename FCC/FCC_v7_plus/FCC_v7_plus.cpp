...
int main(int argc, char* argv[])
{
	...
	input_dir 	= "/FCC/Input/";
	output_dir 	= "/Build/FCC/outputs/FCC_v7_plus/";

		
	string batch_directory="3April_Twiss/";
...
************************************/
	...
	if(crossing){
		myMADinterface = new MADInterface( directory+input_dir+"fcc_lattice_v7_plus_0300_crossing.tfs", beam_energy );		
	}
	else{
		myMADinterface = new MADInterface( directory+input_dir+"fcc_lattice_v7_plus_0300_nocrossing.tfs", beam_energy );
	}
...
****************************/
	...
	if(crossing){
		myApertureConfiguration = new ApertureConfiguration(directory+input_dir+"fcc_v7_plus_0300_aperture.tfs",0);    	
	}
	else{
		myApertureConfiguration = new ApertureConfiguration(directory+input_dir+"fcc_v7_plus_0300_aperture.tfs",0);     
	}
