...
int main(int argc, char* argv[])
{
	...
	input_dir 	= "/FCC/Input/";
	output_dir 	= "/Build/FCC/outputs/off_momentum/";

		
	string batch_directory="27_Nov_inelastic_nearest_forcedloss/";
...
************/
    ...
    if(input_distn){
		...
		ifstream* bunch_input = new ifstream("/home/HR/Downloads/MERLIN_HRThesis/MERLIN/FCC/Input/off_momentum_test.dat");	
