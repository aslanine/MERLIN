...
int main(int argc, char* argv[])
{
	...
	string batch_directory="17May_Composite/";
	...
	bool CollMat				= 1;	// 0 = pure, 1 = composite
...
************/
	...
	if(rf_test){
		...
		//~ myBunchCtor = new ParticleBunchConstructor(mybeam, node_particles, HorizontalHaloDistributionWithLimits);
	}
	else{
