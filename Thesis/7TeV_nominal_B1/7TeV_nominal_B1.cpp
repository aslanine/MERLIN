...
int main(int argc, char* argv[])
{
	...
	if(Alessia){
		directory  	= "/afs/cern.ch/work/a/avalloni/private/MerlinforFluka/MERLIN";	//lxplus avalloni
		output_dir 	= "/Build/UserSim/outputs/7TeV_nominal_B1/";
		input_dir 	= "/UserSim/data/7TeV_nominal_B1/";
	}
	else{	
