...
int main(int argc, char* argv[])
{
    ...
    int ncorepart 	= 1E1;						// number of core particles to track
    int npart 		= 1E1;                     	// number of halo particles to track
	...
	string output_dir = "/Build/Thesis/outputs/ApertureTest/";
