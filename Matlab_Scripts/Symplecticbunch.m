...
tfile = 'Symplectic_tracking_sympbunch.txt';
...
yt=0.75;
xt=0.2;
annotation('textbox', 'Position', [xt yt .10 .10],'EdgeColor','none','Fontsize',8, 'String', 'Halo2','Color', 'g' );
annotation('textbox', 'Position', [xt yt+0.02 .10 .10],'EdgeColor','none','Fontsize',8, 'String', 'SymplecticBunch', 'Color', 'r');
