%% Plot Lattice Functions and Dispersion crossing vs no crossing FCC-hh DS v7
clearvars all;

%% Import TWISS CROSSING
filename = '/home/HR/Downloads/MERLIN_HRThesis/MERLIN/FCC/Input/FCC_Lattice_v7_DS_0300_Crossing.tfs';
delimiter = ' ';
startRow = 48;
